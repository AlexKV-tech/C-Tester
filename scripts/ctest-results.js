...
function renderCTestResults(text, correctAnswers, studentAnswers, scoreData) {
    ...
    while (i < text.length) {
        ...
        if (char === "_") {
            ...
            renderBlankSegment(blankIndex, blankLength, fragment, studentAnswers, scoreData);
            i += blankLength;
            blankIndex++;
        } else {
...
function renderBlankSegment(blankIndex, blankLength, container, studentAnswers, scoreData) {
...
function initializeCTestResults() {
    ...
    renderCTestResults(ctestText, correctAnswers, studentAnswers, scoreData);
}
