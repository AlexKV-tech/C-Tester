...
app.add_middleware(
    SessionMiddleware,
    secret_key=os.getenv("SESSION_SECRET"),  # From environment variables
...
app.mount(
    "/static",
    StaticFiles(directory="static"),  # Serves files from /static directory
    name="static"  # Internal identifier
)
